...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, fr.easybilling.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, fr.easybilling.repository.UserRepository.USERS_BY_EMAIL_CACHE);
