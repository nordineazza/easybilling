...
import fr.easybilling.config.Constants;
import fr.easybilling.domain.User;
import fr.easybilling.repository.AuthorityRepository;
import fr.easybilling.repository.UserRepository;
import fr.easybilling.security.AuthoritiesConstants;
import fr.easybilling.service.UserService;
...
import static fr.easybilling.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
public class AccountResourceIT {
    ...
    public void testNonAuthenticatedUser() throws Exception {
        restAccountMockMvc.perform(get("/authenticate")
    ...
    public void testGetExistingAccount() throws Exception {
        ...
        restAccountMockMvc.perform(get("/account")
            .accept(MediaType.APPLICATION_JSON))
            .andExpect(status().isOk())
    ...
    public void testActivateAccount() throws Exception {
        ...
        restAccountMockMvc.perform(get("/activate?key={activationKey}", activationKey))
            .andExpect(status().isOk());
    ...
    public void testActivateAccountWithWrongKey() throws Exception {
        restAccountMockMvc.perform(get("/activate?key=wrongActivationKey"))
            .andExpect(status().isInternalServerError());
    }
    ...
    public void testChangePasswordWrongExistingPassword() throws Exception {
        ...
        restAccountMockMvc.perform(post("/account/change-password")
            .contentType(MediaType.APPLICATION_JSON)
    ...
    public void testRequestPasswordReset() throws Exception {
        ...
        restAccountMockMvc.perform(post("/account/reset-password/init")
